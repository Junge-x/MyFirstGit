...
class EditableTableUser extends React.Component {
  ...
  handleDelete(key) {
    ...
    axios.get('http://localhost:8080/deleterole',
  ...
  componentDidMount() {
    debugger;
    axios.get('http://localhost:8080/listrole').then((res) => {
      console.log(res);
      var data = [];
      debugger;
      res.data.map((value) => {
  ...
  InsertUser(){
    ...
    axios.post('http://localhost:8080/insertrole', role).then((res) => {
      console.log(res);
      if (res.data == 'success') {
  ...
  handleCreate() {
    debugger;
    let role = this.state.NewRole;
    axios.post('http://localhost:8080/updaterole', role).then((res) => {
      console.log(res);
      if (res.data == 'success') {
        this.handleCancel();
        this.componentDidMount();
